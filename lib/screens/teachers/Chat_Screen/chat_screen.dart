...
import 'package:school_management_app/screens/teachers/Chat_Screen/data/chat_data.dart';
import 'package:school_management_app/screens/teachers/Chat_Screen/model/chat_model.dart';
import 'package:school_management_app/screens/teachers/Chat_Screen/model/student_model.dart'; // Import the image_picker package

class TeachersChatScreen extends StatefulWidget {
  final Student student;

  const TeachersChatScreen({super.key, required this.student});

  static const routeName = 'TeachersChatScreen';

  @override
  State<TeachersChatScreen> createState() => _TeachersChatScreenState();
}

class _TeachersChatScreenState extends State<TeachersChatScreen> {
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final messages = chatMessages[index];
                return MessageWidget(message: messages);
              },
            ),
          ),
          Padding(
