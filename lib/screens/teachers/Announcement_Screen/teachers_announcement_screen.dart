...
class _AdminAnnouncementScreenState extends State<TeacherAnnouncementScreen> {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // Expanded(
            //   child: FutureBuilder<List<TeacherAnnouncement>>(
  ...
  Widget _buildAnnouncementCard(TeacherAnnouncement announcement) {
    return Card(
